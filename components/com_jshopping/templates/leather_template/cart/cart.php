...
?>
<div class="jshop cart_step col-md-10 col-sm-9 col-xs-12" id="comjshop">
        ...
        <td class="quantity">
            ...
            <div class="data">
                ...
                <span class = "cart_reload">
                    <img src="/joomlastayn/templates/mytemplate/images/refresh.png"  alt = "<?php print
                        _JSHOP_UPDATE_CART ?>" onclick="document.updateCart.submit();" />
                </span>
            </div>
        </td>
        ...
        <td class="remove">
            ...
            <div class="data">
                <a class="button-img" href="<?php print $prod['href_delete']?>" onclick="return confirm('<?php print _JSHOP_CONFIRM_REMOVE?>')">
                    <img src = "/joomlastayn/templates/mytemplate/images/delete.png" alt = "<?php print _JSHOP_DELETE?>" title = "<?php print _JSHOP_DELETE?>" />
                </a>
            </div>
        </td>
    </tr>
