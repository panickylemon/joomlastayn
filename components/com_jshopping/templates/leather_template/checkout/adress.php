...
<div id="comjshop ">
	<div class="col-md-10 col-sm-9 col-xs-12">
		...
		<div class="jshop address_block ">
			<p class="title_order">Форма быстрого оформления заказа</p>
			<?php
			...
			<form action="<?php print $this->action ?>" method="post" name="loginForm"
				...
				<div class="jshop_register">
					<?php if ($config_fields['title']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_REG_TITLE ?> <?php if ($config_fields['title']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['f_name']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								ФИО <?php if ($config_fields['f_name']['require']) { ?><span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['l_name']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_L_NAME ?> <?php if ($config_fields['l_name']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['m_name']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_M_NAME ?> <?php if ($config_fields['m_name']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['firma_name']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_FIRMA_NAME ?> <?php if ($config_fields['firma_name']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="firma_name" id="firma_name"
								       value="<?php print $this->user->firma_name ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['client_type']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_CLIENT_TYPE ?> <?php if ($config_fields['client_type']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['firma_code']['display']) { ?>
						<div class="control-group" id='tr_field_firma_code'
							...
							<div class="control-label name">
								<?php print _JSHOP_FIRMA_CODE ?> <?php if ($config_fields['firma_code']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="firma_code" id="firma_code"
								       value="<?php print $this->user->firma_code ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['tax_number']['display']) { ?>
						<div class="control-group" id='tr_field_tax_number'
						     <?php if ($config_fields['client_type']['display'] && $this->user->client_type != "2"){ ?>style="display:none;"<?php } ?>>
							<div class="control-label name">
								<?php print _JSHOP_VAT_NUMBER ?> <?php if ($config_fields['tax_number']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="tax_number" id="tax_number"
								       value="<?php print $this->user->tax_number ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['email']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_EMAIL ?> <?php if ($config_fields['email']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['email2']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_EMAIL2 ?> <?php if ($config_fields['email2']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="email2" id="email2" value="<?php print $this->user->email ?>"
								       class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['birthday']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_BIRTHDAY ?> <?php if ($config_fields['birthday']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['home']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_HOME ?> <?php if ($config_fields['home']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['apartment']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_APARTMENT ?> <?php if ($config_fields['apartment']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="apartment" id="apartment"
								       value="<?php print $this->user->apartment ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['street']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_STREET_NR ?> <?php if ($config_fields['street']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								...
								<?php if ($config_fields['street_nr']['display']) { ?>
									<input type="text" name="street_nr" id="street_nr"
									       value="<?php print $this->user->street_nr ?>" class="input"/>
								<?php } ?>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['zip']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_ZIP ?> <?php if ($config_fields['zip']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['city']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								Адрес (если необходима доставка) <?php if ($config_fields['city']['require']) { ?>
									<span>*</span><?php
								} ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['state']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_STATE ?> <?php if ($config_fields['state']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['country']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_COUNTRY ?> <?php if ($config_fields['country']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['phone']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_TELEFON ?> <?php if ($config_fields['phone']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['mobil_phone']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_MOBIL_PHONE ?> <?php if ($config_fields['mobil_phone']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="mobil_phone" id="mobil_phone"
								       value="<?php print $this->user->mobil_phone ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['fax']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_FAX ?> <?php if ($config_fields['fax']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['ext_field_1']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_EXT_FIELD_1 ?> <?php if ($config_fields['ext_field_1']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="ext_field_1" id="ext_field_1"
								       value="<?php print $this->user->ext_field_1 ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['ext_field_2']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_EXT_FIELD_2 ?> <?php if ($config_fields['ext_field_2']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="ext_field_2" id="ext_field_2"
								       value="<?php print $this->user->ext_field_2 ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['ext_field_3']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_EXT_FIELD_3 ?> <?php if ($config_fields['ext_field_3']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="ext_field_3" id="ext_field_3"
								       value="<?php print $this->user->ext_field_3 ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
				...
				<div id="div_delivery" class="jshop_register"
					...
					<?php if ($config_fields['d_title']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_REG_TITLE ?> <?php if ($config_fields['d_title']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['d_f_name']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_F_NAME ?> <?php if ($config_fields['d_f_name']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="d_f_name" id="d_f_name"
								       value="<?php print $this->user->d_f_name ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['d_l_name']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_L_NAME ?> <?php if ($config_fields['d_l_name']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="d_l_name" id="d_l_name"
								       value="<?php print $this->user->d_l_name ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['d_m_name']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_M_NAME ?> <?php if ($config_fields['d_m_name']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="d_m_name" id="d_m_name"
								       value="<?php print $this->user->d_m_name ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['d_firma_name']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_FIRMA_NAME ?> <?php if ($config_fields['d_firma_name']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="d_firma_name" id="d_firma_name"
								       value="<?php print $this->user->d_firma_name ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['d_email']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_EMAIL ?> <?php if ($config_fields['d_email']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="d_email" id="d_email"
								       value="<?php print $this->user->d_email ?>"
								       class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['d_birthday']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_BIRTHDAY ?> <?php if ($config_fields['d_birthday']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['d_home']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_HOME ?> <?php if ($config_fields['d_home']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['d_apartment']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_APARTMENT ?> <?php if ($config_fields['d_apartment']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="d_apartment" id="d_apartment"
								       value="<?php print $this->user->d_apartment ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
					...
					<?php if ($config_fields['d_street']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_STREET_NR ?> <?php if ($config_fields['d_street']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="d_street" id="d_street"
								       value="<?php print $this->user->d_street ?>" class="input"/>
								<?php if ($config_fields['d_street_nr']['display']) { ?>
									<input type="text" name="d_street_nr" id="d_street_nr"
									       value="<?php print $this->user->d_street_nr ?>" class="inputbox"/>
								<?php } ?>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['d_zip']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_ZIP ?> <?php if ($config_fields['d_zip']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['d_city']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_CITY ?> <?php if ($config_fields['d_city']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['d_state']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_STATE ?> <?php if ($config_fields['d_state']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="d_state" id="d_state"
								       value="<?php print $this->user->d_state ?>"
								       class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['d_country']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_COUNTRY ?> <?php if ($config_fields['d_country']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['d_phone']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_TELEFON ?> <?php if ($config_fields['d_phone']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="d_phone" id="d_phone"
								       value="<?php print $this->user->d_phone ?>"
								       class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['d_mobil_phone']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_MOBIL_PHONE ?> <?php if ($config_fields['d_mobil_phone']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="d_mobil_phone" id="d_mobil_phone"
								       value="<?php print $this->user->d_mobil_phone ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['d_fax']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_FAX ?> <?php if ($config_fields['d_fax']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
					...
					<?php if ($config_fields['d_ext_field_1']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_EXT_FIELD_1 ?> <?php if ($config_fields['d_ext_field_1']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="d_ext_field_1" id="d_ext_field_1"
								       value="<?php print $this->user->d_ext_field_1 ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['d_ext_field_2']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_EXT_FIELD_2 ?> <?php if ($config_fields['d_ext_field_2']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="d_ext_field_2" id="d_ext_field_2"
								       value="<?php print $this->user->d_ext_field_2 ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
					<?php if ($config_fields['d_ext_field_3']['display']) { ?>
						<div class="control-group">
							<div class="control-label name">
								<?php print _JSHOP_EXT_FIELD_3 ?> <?php if ($config_fields['d_ext_field_3']['require']) { ?>
									<span>*</span><?php } ?>
							</div>
							<div class="controls">
								<input type="text" name="d_ext_field_3" id="d_ext_field_3"
								       value="<?php print $this->user->d_ext_field_3 ?>" class="input"/>
							</div>
						</div>
					<?php } ?>
						...
						<div class="control-group">
							<div class="control-label name">
								<a class="privacy_statement" href="#"
								   onclick="window.open('<?php print SEFLink('index.php?option=com_jshopping&controller=content&task=view&page=privacy_statement&tmpl=component', 1); ?>','window','width=800, height=600, scrollbars=yes, status=no, toolbar=no, menubar=no, resizable=yes, location=no');return false;">
									<?php print _JSHOP_PRIVACY_STATEMENT ?> <?php if ($config_fields['privacy_statement']['require']) { ?>
										<span>*</span><?php } ?>
								</a>
							</div>
							<div class="controls">
				...
				<div class="control-group box_button">
					<div class="controls">
						...
						<?php //print _JSHOP_REQUIRED?><!--</div>-->
						<?php echo $this->_tmpl_address_html_9 ?>
						<input type="submit" name="next" value="<?php print _JSHOP_NEXT ?>"
						       class="button_cart_forward"/>
					</div>
				</div>
			</form>
