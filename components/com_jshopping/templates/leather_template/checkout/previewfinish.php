...
<div id="comjshop">
	<div class="col-md-10 col-sm-9 col-xs-12 cart_step">
		...
		<p class="title_order_shipping">Подтверждение заказа</p>
		...
		<div class="jshop checkout_pfinish_block">
			...
			<div class="checkoutinfo">
				<div class="bill_address">
					<strong>ФИО</strong>:
               <span>
	               <?php print $this->invoice_info['f_name'] ?> <br>
               </span>
					<strong>Адрес доставки</strong>:
               <span>
	               <?php if ($this->invoice_info['city']) {
	                   print $this-> $this->invoice_info['city'];
	               } else {
		               print '-------';
	               }?>
				...
				<?php if (!$this->config->without_payment) { ?>
					<div class="payment_info">
						<strong><?php print _JSHOP_FINISH_PAYMENT_METHOD ?></strong>:
						<span><?php print $this->payment_name ?></span>
					</div>
				<?php } ?>
			</div>
			...
			<form name="form_finish" action="<?php print $this->action ?>" method="post" enctype="multipart/form-data">
				<div class="pfinish_comment_block">
					...
					<div class="field"><textarea class="inputbox" id="order_add_info" name="order_add_info"></textarea>
					</div>
					...
					<div class="box_button">
						...
						<input class="button_cart_finish" type="submit" name="finish_registration"
