...
<?php print $product->_tmp_var_start ?>
	<div class="one_product product productitem_<?php print $product->product_id ?>">
		...
		<div class="row_name_price_all_products">
			<div class="name ">
				<a href="<?php print $product->product_link ?>">
			...
			<div class="oiproduct ">
				...
				<?php if ($product->basic_price_info['price_show']) { ?>
					<div class="base_price">
						...
						<span><?php print formatprice($product->basic_price_info['basic_price']) ?>
							/ <?php print $product->basic_price_info['name']; ?></span>
					</div>
				<?php } ?>
