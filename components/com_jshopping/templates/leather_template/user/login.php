...
<div class="jshop pagelogin" id="comjshop">
	<h1>Войти или создать свой аккаунт</h1>
	...
	<div class="row-fluid">
		<div class="span6 login_block col-sm-6 col-xs-12">
			<div class="wrapper_login_block">
				<?php echo $this->tmpl_login_html_2 ?>
				<div class="small_header">Авторизация</div>
		...
		<div class="span6 register_block right col-sm-6 col-xs-12">
			<div class="wrapper_register_block">
				<?php echo $this->tmpl_login_html_4 ?>
				<span class="small_header">Регистрация</span>
